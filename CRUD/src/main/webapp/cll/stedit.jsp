...
String upsucc = (String) session.getAttribute("upsucc");
String errsucc = (String) session.getAttribute("errsucc");
%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>CRUD?Stu_D?Edit</title>
		...
		<div class="row">
			...
			<div class="col-md-10 mt-5">
				...
				<div class="container mt-4">
					...
					<%
					if (upsucc != null || errsucc != null) {
					%>
					<div class="container-fluid ">
					<div class="alert alert-success fixed-top top-right m-3" role="alert">
						<h6
							class=" fs-md <%=(upsucc != null) ? "text-success" : "text-danger"%>">
							<%=(upsucc != null) ? upsucc : errsucc%></h6>
					...
					session.removeAttribute("upsucc");
					session.removeAttribute("errsucc");
					%>
				</div>
				<!-- Breadcrumb -->
				<div style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
					<ol class="breadcrumb mt-2">
						...
						<li class="breadcrumb-item"><a
							href="stdetail.jsp?id=<%=aid.getId()%>&s_ID=<%=sta.getS_ID()%>">Student Profile</a></li>
				...
				<div class="row gutters-sm">
					...
					<div class="col-md-8">
						<div class="card mb-3">
							<div class="card-body">
								<form class="form" action="../editstu" method="post">
									<input type="hidden" name="edit" value="<%=s_ID%>"> <input
										type="hidden" name="pedit" value="<%=p_ID%>">
									...
									<div class="row">
										...
										<div class="col-sm-3 text-secondary">
											<input type="number" class="form-control" name="emobile"
												value="<%=sta.getS_mobile()%>">
										</div>
									</div>
									<hr>
									<div class="row">
										...
										<div class="col-sm-4 text-secondary">
											<input type="number" class="form-control" name="euniver"
												value="<%=sta.getS_univer()%>">
										</div>
									</div>
									<hr>
									<div class="row">
										...
										<div class="col-sm-4 text-secondary">
											<input type="text" class="form-control" name="eadmn"
												value="<%=sta.getS_adm()%>">
										</div>
									</div>
									<hr>
									...
									<div class="row">
										...
										<div class="col-sm-3 text-secondary">
											<input type="text" class="form-control" name="eyear"
												value="<%=sta.getYear_sem()%>">
										</div>
									</div>
									<hr>
									...
									<div class="row">
										...
										<div class="col-sm-3 text-secondary">
											<input type="text" class="form-control" name="egender"
												value="<%=sta.getP().getGender()%>">
										</div>
									</div>
									<hr>
									<div class="row">
									...
									<div class="row">
										...
										<div class="col-sm-3 text-secondary">
											<input type="number" class="form-control" name="efmobile"
												value="<%=sta.getP().getF_numb()%>">
										</div>
									</div>
									<hr>
									<div class="row">
									...
									<div class="row">
										<div class="form-control col-sm-12">
											...
											<a class="btn btn-outline-secondary"
												href="stdetail.jsp?id=<%=aid.getId()%>&s_ID=<%=sta.getS_ID()%>">Back</a>
										</div>
									</div>
								</form>
							</div>
